                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInLeft" data-delay="200ms">Voyage</h6>
                                    <h2 data-animation="fadeInLeft" data-delay="500ms">Welcome to RazoVoyages</h2>
                                    <a href="#" class="btn roberto-btn btn-2" data-animation="fadeInLeft" data-delay="800ms">Voyager Maintenant</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="#" method="post">
                        <div class="row justify-content-between align-items-end">
                            ...
                            <div class="col-4 col-md-1">
                                <label for="room">Room</label>                            <li class="nav-item">
        ...
        <div class="rooms-slides owl-carousel">
           @foreach ($voyages as $voyage)
            ...
            <div class="single-room-slide d-flex align-items-center">
                ...
                <div class="room-thumbnail h-100 bg-img" style="background-image: url({{ $voyage->image }});"></div>

                <!-- Content -->

                <div class="room-content">
                    <h2 data-animation="fadeInUp" data-delay="100ms">{{ $voyage->destination }}</h2>
                    <h3 data-animation="fadeInUp" data-delay="300ms">{{ $voyage->prix }}€ <span> 3 Jours</span></h3>
                    ...
                    <a href="{{route('show', ['id_voyage'=> $voyage->id ])}}" class="btn roberto-btn mt-30" data-animation="fadeInUp" data-delay="700ms">Information Voyage</a>
